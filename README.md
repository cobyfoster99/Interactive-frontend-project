...
I ran into a few minor problems when connecting with Mailchimp API. Unfortunatly due to the Mailchimp systems I was unable to add this to my website. Instead I had to link the subscription form to go to the real form onClick of the subscribe button. In a real world scenario I would have set this up so that the end user does not have to leave the website, unfortunatly you are unable to do this with GitHub pages.
...
There were a few constraints but the pros ended up weighing out the cons. For e.g GitHub pages is a free alternative that allows me to host the site on a secure server without having to go through server setup (I have done this many times in the past using SiteGround on real world projects).


### Revision Control

I used Github for revision control. Within my GitHub you will be able to see my commits and version control. Within this I have added files for testing, updates to CSS, adding new content ect. 
